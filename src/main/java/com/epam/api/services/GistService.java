...
import com.epam.api.bo.HttpRequestType;
import com.epam.api.exceptions.HttpClientException;
...
public class GistService {
   ...
   public HttpRequestBase getHttpTokenAuthorization(String uri, HttpRequestType type) {
        ...
        httpRequest.setHeader("Authorization", requireNonNull(System.getenv(ENV_VARIABLE),() -> "The mandatory env variable " + ENV_VARIABLE + " is not retrieved."));
        return httpRequest;
    }
